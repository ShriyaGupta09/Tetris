...
class SBlock(Block):
    def __init__(self):
        ...
        self.cells = {
            ...
            1: [Position(2, 1), Position(1, 1), Position(1, 0), Position(0, 0)],
...
class TBlock(Block):
    def __init__(self):
        ...
        self.cells = {
            ...
            2: [Position(0, 1), Position(1, 1), Position(2, 1), Position(1, 2)],
            3: [Position(1, 0), Position(1, 1), Position(1, 2), Position(0, 1)],
        }
        self.move(0, 3)
